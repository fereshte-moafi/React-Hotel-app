...
const data = [
  {
    ...
    fields: {
      ...
      extras: [
        "بالش های پرزدار و روتختی های قابل تنفس",
        "حوله های نرم و بزرگ حمام",
        "سرویس های بهداشتی بااندازه کامل و متعادل با pH",
        "تنقلات مکمل",
        "ایمنی / امنیت کافی",
        "اینترنت",
        "تخت خواب های راحت",
